Meteor.startup(function() {
 if (Meteor.isClient) {
        ...
        Template.Patient_ID.helpers({
         ...
         function bindField(field, dependsOn) {
             ...
             Tracker.autorun(function () {
                ...
                var p = CRFcollections.Patient_Enrollment_form.find(q, { fields: f}).fetch();
        ...
        Template.Sample_ID.rendered = function ()  {
            bindField("Sample_ID", "Patient_ID");
        };
       ...
       Meteor.subscribe("Sample_IDs");
        ...
        Meteor.publish("Sample_IDs", function() {
            if (this.userId) {
                ...
                var p =  CRFcollections.Biopsy_Research.find({}, {sort: {Sample_ID:1}, fields: { Sample_ID:1}});
