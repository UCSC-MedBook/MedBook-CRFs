 ...
 if (Meteor.isClient) {
            ...
            Template.Patient_ID.rendered = function ()  {
              ...
              this.autorun(function () {
               ...
               CRFcollections['Demographics'].find({}, {fields: {Patient_ID:1, Study_Site:1}}).forEach(
                   function(p) {var pid = p.Patient_ID + " " + p.Study_Site; 
        ...
        if (true) {
            ...
            Template.Sample_ID.rendered = function ()  {
              ...
              this.autorun(function () {
               ...
               CRFcollections['SU2C_Biopsy_V2'].find({}, {fields: {Sample_ID:1, Site:1}}).forEach(
                   function(p) {var pid = p.Sample_ID + " " + p.Site; 
                         $("<option>", { value: pid, html: pid}).appendTo($select);
                       });
               }); // autorun
               updateSampleInfo();
