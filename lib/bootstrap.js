...
CRFprototypes = {
  ...
  'GU-Disease_Assessment_V3': { 
    ...
    'Are_Lesions_Present?': { optional: true, type: 'String' },
     ...
     'Date_of_Procedure_Ext': { optional: true, type: 'Date' },
     Day: { optional: true, type: 'Number' },
     Phase: { optional: true, type: 'String' },
  ...
  'Prostate_Diagnosis_V2': { 
     Patient_ID: {  type: 'String' },
    'Date_of_diagnosis_Ext': { optional: true, type: 'Date' },
     Day: { optional: true, type: 'Number' },
  ...
  'SU2C_Biopsy_AE_V1': { 
    ...
    'Best_Response': { optional: true, type: 'String' },
     ...
     'Onset_Date_Ext': { optional: true, type: 'Date' },
     Outcome: { optional: true, type: 'String' },
     'Resolved_Date__Log_Column_': { optional: true, type: 'Date' },
     'Resolved_Date__Log_Column__Ext': { optional: true, type: 'Date' },
  ...
  'SU2C_Pr_Ca_Tx_Sumry_V2': {
     ...
     Segment: { optional: true, type: 'String' },
     'Start_Date_Ext': { optional: true, type: 'Date' },
     'Stop_Date_Ext': { optional: true, type: 'Date' },
     'Surgery_Date_Ext': { optional: true, type: 'Date' },
     'Visit_Date': { optional: true, type: 'Date' },
...
TableNeedsSample_ID = [
    ...
    ["Blood_Labs_V2", true,],
    ["ECOG-Weight_V2", true,],
    ["GU-Disease_Assessment_V3", true,],
    ["SU2C_Biopsy_AE_V1", true,],
    ["SU2C_Biopsy_V2", true,],
    ["SU2C_Pr Ca_Tx_Sumry_V2", true,],
...
function mapPatient(patient) {
    ...
    if (biopsies) {
        ...
        if ( biopsies.length >= 1)
            baseline = biopsies[0]["Date_of_Procedure"]
        if ( biopsies.length >= 2)
            pro = biopsies[1]["Date_of_Procedure"]
        if ( biopsies.length >= 3)
            pro2 = biopsies[2]["Date_of_Procedure"]
    }
        ...
        if (n) {
            ...
            if (rows) {
                for (var i = 0; i < rows.length; i++) {
                    ...
                    var d = t == "SU2C_Biopsy_V2" ? row["Date of Procedure"] : row["Visit Date"];
