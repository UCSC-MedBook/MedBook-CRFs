...
ingestOncore = function () {
	...
	var data = {}
	var samples = {}
	var p_sample_list = SU2C_Prior_TX_V3.find({})
	ingestClinical();
}
...
get_PSA_response = function(sample, date) {
   ...
   */
    ...
    */
    ...
    CRFfieldOrder['Laser_Capture_Microdissection']=["Sample_ID","Core", "Completion_Date", 'SlideNumber', "Estimated_total_capture_area", "Lysates", "Lysates_Volume", "Downstream_use"];
