...
Router.map(function() {
  ...
  this.route('CRFsShow', {
    ...
    onBeforeAction: function() {
      ...
      this.CRFsHandle = Meteor.subscribe('CRFs', this.params.formName);
      Meteor.subscribe('collaboration', this.params.formName)
      this.next();
    },
    data: function() {
      return CRFmetadataCollection.findOne(this.params.formName);
    }
  });
