...
exports.command = function(laserCaptureRecord, rowIndex) {
  this
    ...
    if(laserCaptureRecord){
      ...
      .verify.elementPresent("table thead tr:nth-child(" + rowIndex + ") .SlideNumber")
      .verify.elementPresent("table thead tr:nth-child(" + rowIndex + ") .Estimated_total_capture_area")
      .verify.elementPresent("table thead tr:nth-child(" + rowIndex + ") .Lysates")
      .verify.elementPresent("table thead tr:nth-child(" + rowIndex + ") .Lysates_Volume")
      .verify.elementPresent("table thead tr:nth-child(" + rowIndex + ") .Downstream_use")

      .verify.containsText("table thead tr:nth-child(" + rowIndex + ") .Sample_ID", laserCaptureRecord.sampleId )
      .verify.containsText("table thead tr:nth-child(" + rowIndex + ") .Core", laserCaptureRecord.core )
      .verify.containsText("table thead tr:nth-child(" + rowIndex + ") .Completion_Date", laserCaptureRecord.completionDate )
      .verify.containsText("table thead tr:nth-child(" + rowIndex + ") .SlideNumber", laserCaptureRecord.slideNumber )
