...
exports.command = function(pathologyRecord, rowIndex) {
  this
    ...
    if(pathologyRecord){
      ...
      //.verify.elementPresent("table tbody tr:nth-child(" + rowIndex + ") .AR_amplification")
      ...
      //.verify.containsText("table tbody tr:nth-child(" + rowIndex + ") .AR_amplification", pathologyRecord.)
