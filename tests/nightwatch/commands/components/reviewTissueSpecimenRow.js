...
exports.command = function(tissueSpecimenRecord, rowIndex) {
  this
    ...
    if(tissueSpecimenRecord){
      ...
      //.verify.elementPresent("table tbody tr:nth-child(" + rowIndex + ") .Biopsy_Site")
      ...
      //.verify.containsText("table tbody tr:nth-child(" + rowIndex + ") .Biopsy_Site", tissueSpecimenRecord.biopsySite )
      ...
      //.verify.containsText("table tbody tr:nth-child(" + rowIndex + ") .Freezer", tissueSpecimenRecord. )
